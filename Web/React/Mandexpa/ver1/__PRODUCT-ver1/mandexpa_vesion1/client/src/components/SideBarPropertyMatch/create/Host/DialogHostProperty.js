...
class DialogHostProperty extends Component {
    ...
    chooseHost = (info_contact) => {
        this.props.chooseHost(info_contact).then((res) =>{
            this.props.parent_get_data({host_id:res.payload.id,host_name:res.payload.name});
        });
            ...
            <div>
                                                ...
                                                <div className="row">
                                                    <div className="col-12 col-sm-6">
                                                        <FormControl className="form-group"
                                                            ...
                                                            <label className="">{<IntlMessages
                                                                id="property.main.source_prospect"/>}</label>
                                                            <div className="heightIP40 col-12 col-sm-8">
                                                                <div>
                                                                    <input type="text"
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-6 col-12">
                                                            <FormControl className="form-group"
                                                                ...
                                                                <label className="col-form-label obligateField">{<IntlMessages
                                                        ...
                                                        <div className="col-sm-6 col-12">
                                                            <FormControl className="form-group"
                                                                ...
                                                                <label className="col-form-label obligateField"><span
                                                                    className="obligate">*</span>Téléphone mobile
                                                                    {/* {<IntlMessages
                                                                    id="contact.cell_phone"/>} */}
                                                    ...
                                                    <div className="row">
                                                        <div className="col-sm-6 col-12">
                                                            <FormControl className="form-group"
                                                                ...
                                                                <div>
                                                                    <div className="heightIP40 col-6">
                                                                        <input type="text"
                                                                               className="form-control"
                                                                               name="lastname"
                                                                               placeholder=""
                ...
                <span style={divStyle}>
                    <button className="btn btn-primary"
                        ...
                        <IntlMessages id="property.main.host.add.propertymatch"/>
                    </button>
                </span>
            </div>
        )
...
const createForm = withFormik({
    ...
    handleSubmit(values, {props, setSubmitting, resetForm}) {
        ...
        if (firstname !== "" && lastname !== "" && email !== "" && mobile !== "" ) {
            props.createHost(values).then((res) =>{
                props.parent_get_data({host_id:res.payload.id,host_name:res.payload.name});
            });
            resetForm();
...
const mapDispatchToProps = (dispatch, props) => {
    return {
        createHost: (data) => {
            return dispatch(createHost(data));
        },
        chooseHost: (data) => {
            return dispatch(chooseHost(data));
        },
        getAllCountry: () => {
